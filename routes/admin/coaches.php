...
Route::prefix('coach')->group(function () {
    ...
    Route::prefix('evaluation-manager')->group(function () {
        ...
        Route::get('/show/{coach}', \App\Http\Controllers\Admin\Coach\EvaluationManager\ShowEvaluationManagerController::class)
            ->name('get.admin.coach.evaluation_manager.show');

        Route::prefix('file')->group(function () {

            Route::get('download/{file}', \App\Http\Controllers\Admin\Coach\EvaluationManager\DownloadEvaluationManagerController::class)
                ->name('get.admin.coach.evaluation_manager.file.download');
        });
    });
