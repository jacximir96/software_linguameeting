           ...
           <div class="col-row mt-3">
            ...
            <div class="row mt-2">
                    <div class="col-12 ps-4">
                        <a href="#" target="_blank" class="me-3" title="Go to asdf">
                            <span class="text-dark">1.</span> <span>asdf</span>
                        </a>
                    </div>
                </div>
