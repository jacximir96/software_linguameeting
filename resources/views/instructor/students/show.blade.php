                    ...
                    <div class="col-md-12">
                        <div class="row mt-2">
                            <div class="col-md-6">
                                ...
                                <div class="text-corporate-dark-color mt-2"><u>Last Login: May 10 2023</u></div>
                                ...
                                <div  class="mt-4 float-none">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <div class="col-md-4">
                                                <button class="btn btn-danger btn-bold form-control-xs px-4 colorWhite" value="Save">
                                                    Delete Student
                                                </button>
                                            </div>
                                        </div>
