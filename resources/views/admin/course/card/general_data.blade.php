    ...
    <div class="card-body">
        ...
        <div class="row gx-3">
            ...
            <div class="col-md-6 col-xl-4">
                @include('common.card_field', ['tag' => 'Type Course', 'value' => $course->conversationPackage->description_with_only_isbn])

                @if ($course->serviceType->isCombined())
                    <span class="d-block fst-italic mt-1">Conversations + Experiences</span>
                @endif
            </div>

            <div class="col-md-6 col-xl-3">
                @include('common.card_field_tag', ['tag' => 'TextBook'])
                <div class="row">
                    <div class="col-12">
                        {{$course->conversationGuide->name}}
                    </div>
                </div>
            </div>
        ...
        <div class="row gx-3 mb-4">
            ...
            <div class="col-md-4">
                <div class="row">
                    <div class="col-12">
                        <label class="me-3 fw-bold text-corporate-color">Holidays</label>
                    </div>
                </div>
                <div class="row">
                    <div class="col-12">
        ...
        <div class="row gx-3">
            ...
            <div class="col-md-6 col-lg-2">
                @include('common.card_field', ['tag' => 'Experiences?', 'value' => $course->conversationPackage->hasExperiences() ? 'Yes' : 'No'])
            </div>
            ...
            <div class="col-md-6 col-lg-2">
                @include('common.card_field', ['tag' => 'Price', 'value' => $linguaMoney->format($course->conversationPackage->price)])
            </div>
        ...
        <div class="row gx-3 mb-4">
            ...
            <div class="col-md-6 col-lg-4">
                @include('common.card_field', ['tag' => 'Students per session', 'value' => $course->student_class])
            </div>
        ...
        <div class="row gx-3 mb-4">
            ...
            <div class="col-md-6 col-lg-4">
                @include('common.card_field', ['tag' => 'Make-ups available to students', 'value' => $course->printMakeupsNumber()])
            </div>

            <div class="col-md-6 col-lg-8">
                <div class="row">
                    <div class="col-12">
                        <label class="me-3 fw-bold text-corporate-color">Only Week Make-up</label>
                    </div>
                </div>
                <div class="row">
                    <div class="col-12">
                        <span class="d-inline-block">{{$course->onlyWeekMakeups() ? 'Yes' : 'No'}}</span>
                        <span class="text-muted small-font-size-08 d-inline-block ms-2">Only allow make-ups to be used during the original session's dates?</span>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        @if ($course->hasAudits())
                            ...
                            <span class="d-block small">
                                {{toDatetimeInOneRow($course->audits()->latest()->first()->created_at, $timezone)}}
                            </span>
                        @else
                            <span class="">
                                Without Data
