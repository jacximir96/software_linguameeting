...
class DeleteEnrollmentAction
{
    ...
    public function handle(Enrollment $enrollment): Enrollment
    {
        ...
        try {
            ...
            $this->deleteEnrollmentSessions($enrollment);
    ...
    private function deleteEnrollmentSessions(Enrollment $enrollment)
    {

        foreach ($enrollment->enrollmentSession as $session) {
            $this->cancelEnrollmentSessionAction->handle($session);
        }
    }
}
